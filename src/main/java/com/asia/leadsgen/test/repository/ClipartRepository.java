...
//	List<ClipartEntityResponse> listLikeName(Pageable pageable, Long userId, String name, Date startDate, Date endDate);
	...
	List<ClipartEntityResponse> list(Pageable pageable, Long userId);
	...
	List<ClipartEntityResponse> listLikeName(Pageable pageable, Long userId, String search);
